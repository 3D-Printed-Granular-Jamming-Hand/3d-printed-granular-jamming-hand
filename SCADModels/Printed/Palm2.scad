	...
	translate([0,0,PlasticWidth()*2.3])
	{
		rotate([0,90,0])
		{
			if (Length > 10)
			{
				...
				{
					translate([-ZipTieLength()+CableGuideHeight(),0,10*i])
					{
						rotate([0,90,0])
						{
							ZipTie();
					...
					translate([-ZipTieLength()+CableGuideHeight(),GuideWidth(),10*i])
					{
						rotate([0,90,0])
						{
							ZipTie();
			...
			{
				translate([-ZipTieLength()+CableGuideHeight(),0,5])
				{
					rotate([0,90,0])
					{
						ZipTie();
				...
				translate([-ZipTieLength()+CableGuideHeight(),GuideWidth(),5])
				{
					rotate([0,90,0])
					{
							ZipTie();
...
{
	translate([PalmLength()-HingeDepth()-PlasticWidth()*2-Length+4.9,FingerWidth()/2-GuideWidth()/2-ZipTieHeight()/2,0])
	{
...
{
	translate([PalmLength()-HingeDepth()+6.9,FingerWidth()/2-GuideWidth()/2-ZipTieHeight()/2+4,0])
	{
